...
Appコンポーネントを除くすべてのコンポーネントはインターフェースを参照することで関連づいている。  
これにより、ユニットテスト時のモッククラスの活用や、DIの活用が可能となっている。

![コンポーネント図詳細](アーキテクチャ設計/アーキテクチャ設計詳細.svg)
